...
public class AdminRegServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean isRegistered = AdminDAO.insertAdmin(admin);

        if (isRegistered) {
            response.sendRedirect("AdminSucess.jsp"); // Redirect to success page after registration
        } else {
            response.sendRedirect("AdminError.jsp"); // Redirect to error page
        }
            out.println("</body>");
            out.println("</html>");
        }
